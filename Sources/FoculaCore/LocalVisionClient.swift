...
public final class LocalVisionClient: VisionClassifying {
    ...
    private func makeRequestBody(
        ...
        System activity context: \(contextSummaryText.joined(separator: " | "))
        Context: \(contextNote)
        ...
        Always write activitySummary when the image or system context gives enough context. Summarize the overall user activity across focused and visible apps, not just the foreground app. Prefer summaries like "Using Codex, Focula, and Reminders to plan app fixes" or "Practicing coding questions while referencing notes". Mention safe app names when they clarify the activity. Do not quote visible text, URLs, emails, chat participants, document titles, private names, or message contents. Use null only when the activity is unclear. Use evidence codes only.
        """
